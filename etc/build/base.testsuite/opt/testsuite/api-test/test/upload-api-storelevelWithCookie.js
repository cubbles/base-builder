...
describe('#upload-api-storelevelWithCookie',
  function () {
    ...
    // use http://jwt.io/ to prepare a token
    it('insert to ' + uploadApiPath + ' should return 201 Created', function (done) {
    ...
    // use http://jwt.io/ to prepare a token
    it('insert to ' + uploadApiPath + ' should return 401 Unauthorized (invalid token)', function (testDone) {
    ...
    // use http://jwt.io/ to prepare a token
    it('insert to ' + uploadApiPath + ' should return 401 Unauthorized (expired token)', function (testDone) {
    ...
    // use http://jwt.io/ to prepare a token
    it('roundtrip: request access_token and try insert doc to ' + uploadApiPath + ' should return 401 Unauthorized', function (testDone) {
